...
This plan returns a typed dictionary ({py:obj}`DetMapAlignResult<ibex_bluesky_core.plans.reflectometry.det_map_align.DetMapAlignResult>`), with the following keys:
...
{py:obj}`DetMapHeightScanLiveDispatcher<ibex_bluesky_core.callbacks.reflectometry.det_map.DetMapHeightScanLiveDispatcher>`
or
{py:obj}`DetMapAngleScanLiveDispatcher<ibex_bluesky_core.callbacks.reflectometry.det_map.DetMapAngleScanLiveDispatcher>`
described below.
...
{py:obj}`LivePColorMesh<ibex_bluesky_core.callbacks.reflectometry.det_map.LivePColorMesh>`
