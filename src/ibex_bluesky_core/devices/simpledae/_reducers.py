...
class DSpacingMappingReducer(Reducer, StandardReadable):
    ...
    This reducer produces one dimensional arrays of d-spacing; these arrays are generated
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            dspacing_bin_edges: scipp Variable describing the required d-spacing bin-edges.
                This must be bin edge coordinates, aligned along a scipp dimension label of
                "tof", and have a unit of length, for example Angstroms (sc.units.angstrom),
